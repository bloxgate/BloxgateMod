...
public class WalkingApple extends ModelBase
{
    //fields
    ModelRenderer head;
    ModelRenderer body;
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
    {
        ...
        this.leg1.rotateAngleX = MathHelper.cos(f * 0.662F) * 1.4F * f1;
        this.leg2.rotateAngleX = MathHelper.cos(f * 0.662F + (float)Math.PI) * 1.4F * f1;
        this.leg3.rotateAngleX = MathHelper.cos(f * 0.662F + (float)Math.PI)  * 0.5F * f1;
        this.leg4.rotateAngleX = MathHelper.cos(f * 0.662F) * 1.4F * f1;
    }
}
