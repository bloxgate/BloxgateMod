...
public class mod_bloxgatemod
{
    ...
    public void init(FMLInitializationEvent event)
    {
       ...
       // MinecraftForge.setBlockHarvestLevel(uraniumBlock, "pickaxe", 2);
        ...
        uraniumPickaxe = (new UraniumPickaxe(toolUranium)).setUnlocalizedName("uraniumPickaxe");
        ...
        uraniumHoe = (new UraniumHoe(toolUranium)).setUnlocalizedName("uraniumHoe");
        ...
        uraniumAxe = (new UraniumAxe(toolUranium)).setUnlocalizedName("uraniumAxe");
